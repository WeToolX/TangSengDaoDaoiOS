...
-(AnyPromise*)publishText:(NSString*)text imagePaths:(NSArray<NSString*>*)imagePaths imageDatas:(NSArray<NSData*>*)imageDatas video:(nullable WKMomentPublishMedia*)video mention:(NSDictionary*)mention visibility:(NSDictionary*)visibility clientReqID:(NSString*)clientReqID;
